...
//			}
			...
			sprintf(command_buffer, "sz -z -f -M REL -R %.10f -i %s -3 69 69 93840", ori_err, file_name);
			...
			sprintf(command_buffer, "sz -x -f -M REL -R %.10f -s %s.sz -i %s -3 69 69 93840 -a", ori_err, file_name, file_name);
			cur_command = ""; cur_command += command_buffer;
			sprintf(command_buffer, " >> %s 2>&1", output_string1.c_str());
			cur_command += command_buffer;
			printf("command2: %s\n", cur_command.c_str());
...
//			sprintf(command_buffer, "zfp -s -i %s -z %s.zfp -o %s.zfp.out -f -a %.10f -3 69 69 93840 > %s 2>&1", file_name, file_name, file_name, ori_err, output_string1.c_str());
			cur_command = ""; cur_command += command_buffer;
			system(cur_command.c_str());
			std::fstream cur_file;
			...
			sprintf(command_buffer, "sz -z -f -M REL -R %.10f -i %s -3 69 69 93840", pred_err, file_name);
			cur_command = ""; cur_command += command_buffer;
			sprintf(command_buffer, " > %s 2>&1", output_string1.c_str());
			cur_command += command_buffer;
			printf("command1: %s\n", cur_command.c_str());
			system(cur_command.c_str());
			 ...
			 sprintf(command_buffer, "sz -x -f -M REL -R %.10f -s %s.sz -i %s -3 69 69 93840 -a", pred_err, file_name, file_name);
			cur_command = ""; cur_command += command_buffer;
			sprintf(command_buffer, " >> %s 2>&1", output_string1.c_str());
			cur_command += command_buffer;
			printf("command2: %s\n", cur_command.c_str());
...
//                        sprintf(command_buffer, "zfp -s -i %s -z %s.zfp -o %s.zfp.out -f -a %.10f -3 69 69 93840 > %s 2>&1", file_name, file_name, file_name, pred_err, output_string1.c_str());
                        cur_command = ""; cur_command += command_buffer;
                        system(cur_command.c_str());
			cur_file.open(output_string1.c_str(), std::ios::in);	
			if(cur_file.is_open()) {
