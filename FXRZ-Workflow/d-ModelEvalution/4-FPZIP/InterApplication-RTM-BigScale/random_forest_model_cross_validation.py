...
cv = RepeatedKFold(n_splits=80, n_repeats=1, random_state=1)
rf_model = RandomizedSearchCV(estimator=rf, param_distributions=random_grid, n_iter=10, cv=cv, refit=True, verbose=3, random_state=42, n_jobs = -1)
