...
int main(int argc, char *argv[]) {
  ...
  pressio_options_set_string(options, "opt:compressor", "zfp");
  ...
  pressio_options_set_string(options, "zfp:metric", "composite");
  ...
  helper_set_data(options, "opt:upper_bound", {0.000055});
